        ...
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              ...
              <Text variant="white" classNamees="font-bold" size="md">
          ...
          <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10 space-y-2 md:mt-6">
                <li>
                  <a className="text-gray-300 hover:text-white">Facebook</a>
                </li>
                <li>
                  <a className="text-gray-300 hover:text-white">Instagram</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10 space-y-2 md:mt-6">
                <li>
                  <a className="text-gray-300 hover:text-white">MamaEarth</a>
                </li>
                <li>
